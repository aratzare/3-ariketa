...
p.textContent = "Inaki entzun pin pan pun";
}
...
if (isNaN(sarrera) || sarrera < 1 || sarrera > 5) {
        emaitza.textContent = "Mesedez, 1 eta 5 arteko zenbaki bat idatzi.";
...
function aldatuAtzekoPlanoarenKolorea() {
    const randomKolorea = "#" + Math.floor(Math.random() * 16777215).toString(16).padStart(6, "0");
